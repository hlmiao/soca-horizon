...
#  OR CONDITIONS OF ANY KIND, express or implied. See the License for the sp`ec`ific language governing permissions    #
...
#	/apps/soca/$SOCA_CONFIGURATION/python/$PYTHON_VERSION/bin/pip3 install -i https://opentuna.cn/pypi/web/simple -r /root/requirements.txt
	/apps/soca/$SOCA_CONFIGURATION/python/$PYTHON_VERSION/bin/pip3 install -i https://pypi.tuna.tsinghua.edu.cn/simple -r /root/requirements.txt
else
